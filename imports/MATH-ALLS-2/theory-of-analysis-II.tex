...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{sinx2_global.png}
	\caption{$f(x)=\sin(x^2)$ on $[-10,10]$.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{sinx2_zoom.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{sinx3_over_xp1_global.png}
	\caption{$f(x)=\sin(x^3)/(x+1)$ on $[-1,20]$ (note the removable pole at $x=-1$).}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{sinx3_over_xp1_tail.png}
...
\begin{center}
	\includegraphics[width=0.86\textwidth]{clipn_sin2_plot.png}
\end{center}
\noindent
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{gprime_semilog.png}
...
\begin{center}
	\includegraphics[width=0.8\textwidth]{phi_periodic_plot.png}
\end{center}
\noindent
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{weierstrass_partial_sums.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{weierstrass_zoom.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=.7\linewidth]{curve_C_xy_plane.png}
	\caption{\textbf{Source plane (x,y).} The curve $C:\; x^3+y^3-3xy=0$.}
\end{figure}

\begin{figure}[!ht]
	\centering
	\includegraphics[width=.7\linewidth]{image_FC_uv_plane.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\linewidth]{F_mapping_xy_to_uv_side_by_side.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=.72\linewidth]{problem14_subharmonic_heatmap.png}
