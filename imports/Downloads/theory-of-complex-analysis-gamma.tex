...
\centering
\includegraphics[width=\linewidth]{gamma_integrand_zmap_rays.png}
\caption{Images of several rays in the \(z\)-plane (fixed \(s\)).}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.48\textwidth}
\centering
\includegraphics[width=\linewidth]{gamma_integrand_zmap_circles.png}
...
\begin{subfigure}[t]{0.48\textwidth}
\centering
\includegraphics[width=\linewidth]{gamma_integrand_smap_vertical.png}
\caption{\(s\)-map for \(\sigma=\sigma_0\) (vary \(\tau\)): circle at fixed \(|I_s(z)|\).}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.48\textwidth}
\centering
\includegraphics[width=\linewidth]{gamma_integrand_smap_horizontal.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.78\linewidth]{gamma_integrand_z_heatmap.png}
