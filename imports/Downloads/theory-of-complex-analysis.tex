...
\begin{figure}[h]
	\centering
	\includegraphics[width=.45\linewidth]{example_rotation_scaling.png}\hfill
	\includegraphics[width=.45\linewidth]{example_conjugation.png}
	\caption{Left: $T(z)=1.3e^{i\pi/6}z$ (holomorphic). Right: $T(z)=\bar z$ (orientation-reversing).}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=.45\linewidth]{example_shear.png}\hfill
	\includegraphics[width=.45\linewidth]{example_general_mixed.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=.45\linewidth]{log_re_heatmap.png}\hfill
	\includegraphics[width=.45\linewidth]{log_im_heatmap.png}
	\caption{Left: $\Re(\Log z)=\ln|z|$. Right: $\Im(\Log z)=\Arg z$ on the principal branch.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=.45\linewidth]{log_mapping_domain.png}\hfill
	\includegraphics[width=.45\linewidth]{log_mapping_image.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=.45\linewidth]{power_mapping_domain.png}\hfill
	\includegraphics[width=.45\linewidth]{power_alpha_real2.png}
	\caption{Left: circles and rays in the $z$-plane. Right: image under $w=z^2$ (principal branch).}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=.45\linewidth]{power_alpha_real_half.png}\hfill
	\includegraphics[width=.45\linewidth]{power_alpha_pure_imag_i.png}
	\caption{Left: $w=z^{1/2}$ (principal root). Right: $w=z^{\,i}$ (pure imaginary exponent).}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=.6\linewidth]{power_alpha_general.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=.55\linewidth]{prob5_eiz_heatmap.png}
	\caption{Heatmap of $|e^{iz}|=e^{-y}$. The region $|e^{iz}|>1$ is $y<0$; boundary $|e^{iz}|=1$ is $y=0$.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=.55\linewidth]{prob5_ineq_heatmap.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=.6\linewidth]{sector_domain.png}
	\caption{Sector domain $-\pi/4<\mathrm{Arg}\,z<\pi/4$.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=.6\linewidth]{sector_to_halfplane.png}
	\caption{Image under $z\mapsto z^2$: right half–plane $\Re w>0$.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=.6\linewidth]{sector_to_disk.png}
	\caption{After Cayley transform: unit disk $\mathbb{D}$.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=.6\linewidth]{lens_domain.png}
	\caption{Lens domain $\{|z-1|<\sqrt{2}\}\cap\{|z+1|<\sqrt{2}\}$.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=.6\linewidth]{lens_to_sector.png}
	\caption{After $M(z)=(z-i)/(z+i)$: sector of opening $\pi/2$.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=.6\linewidth]{strip_domain.png}
	\caption{Strip domain $0<\Im z<1$.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=.6\linewidth]{strip_to_quadrant.png}
