...
\begin{figure}[h!]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{lp_singularities.png}
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{lp_decay.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{lp_boundary_alpha_vs_p.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{lp_norm_vs_p_decay_alpha15.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{lp_log_borderline_norm_vs_gamma_p2.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{lp_integrability_decay.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{exA_f_and_g0.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{exB_f_h_G.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.65\linewidth]{exB_minkowski_bars.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{weakLp_functions.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{weakLp_integrands.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{weakLp_tails.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.82\linewidth]{ex5_moving_intervals.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{ex6_distribution_decay.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{ex6_weak_vs_strong_lp.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.82\linewidth]{ex5_moving_intervals_alt_alpha.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{ex6_distribution_decay_p3.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{ex6_weak_vs_strong_lp_p3.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.8\linewidth]{covering_wiener_3B.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.8\linewidth]{covering_vitali_5B.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.72\linewidth]{two_balls_B_and_3B.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.8\linewidth]{weakLp_decay_family.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.8\linewidth]{weakLp_integrand_tail.png}
...
Thus $w$ is bounded on $L^{p}$.
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=\textwidth]{figureA_dyadic_partition.png}
		\caption{Dyadic partition $E_k=(2^{-k},\,2^{-(k-1)}]$ of $[0,1]$.}
	\end{figure}
	
	\begin{figure}[ht]
		\centering
		\includegraphics[width=\textwidth]{figureB_step_function.png}
		\caption{Step function $\phi$ that is $\pm1$ on each $E_k$ (alternating signs shown).}
	\end{figure}
	
	\begin{figure}[ht]
		\centering
		\includegraphics[width=\textwidth]{figureC_normalized_indicators.png}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.8\textwidth]{figure_lsc_epigraph.png}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.8\textwidth]{figure_lsc_strict_inequality.png}
