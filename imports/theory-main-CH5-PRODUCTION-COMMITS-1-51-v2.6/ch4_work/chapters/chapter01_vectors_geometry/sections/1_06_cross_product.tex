...
\begin{bookfigure}{The magnitude of the cross product equals the area of the parallelogram spanned by the two vectors.}
\input{figures/ch01/parallelogram_area.tex}
\label{fig:parallelogram-area}
\end{bookfigure}

\begin{bookfigure}{Torque measures the rotational action of a force about an origin; its magnitude depends on the perpendicular lever arm.}
