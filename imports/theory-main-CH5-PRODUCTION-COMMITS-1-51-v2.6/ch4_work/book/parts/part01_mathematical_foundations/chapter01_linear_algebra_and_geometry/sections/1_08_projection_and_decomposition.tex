...
\begin{bookfigure}{Orthogonal decomposition into components parallel and perpendicular to a chosen direction.}
\input{figures/ch01/orthogonal_projection.tex}
\end{bookfigure}
...
\input{legacy_sources/chapters_pre_PR_BOOK_10/chapter01_vectors/fig12_vector_projection.tex}
\endgroup
...
\input{legacy_sources/chapters_pre_PR_BOOK_10/chapter01_vectors/fig10_component_decomposition.tex}
\endgroup
