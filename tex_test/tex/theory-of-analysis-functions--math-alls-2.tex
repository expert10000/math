...
\begin{figure}[h!]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/MATH-ALLS-2_lp_singularities.png}
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/MATH-ALLS-2_lp_decay.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{figures/MATH-ALLS-2_lp_boundary_alpha_vs_p.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{figures/MATH-ALLS-2_lp_norm_vs_p_decay_alpha15.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{figures/MATH-ALLS-2_lp_log_borderline_norm_vs_gamma_p2.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{figures/MATH-ALLS-2_lp_integrability_decay.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{figures/MATH-ALLS-2_exA_f_and_g0.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{figures/MATH-ALLS-2_exB_f_h_G.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.65\linewidth]{figures/MATH-ALLS-2_exB_minkowski_bars.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{figures/MATH-ALLS-2_weakLp_functions.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{figures/MATH-ALLS-2_weakLp_integrands.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{figures/MATH-ALLS-2_weakLp_tails.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.82\linewidth]{figures/MATH-ALLS-2_ex5_moving_intervals.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{figures/MATH-ALLS-2_ex6_distribution_decay.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{figures/MATH-ALLS-2_ex6_weak_vs_strong_lp.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.82\linewidth]{figures/MATH-ALLS-2_ex5_moving_intervals_alt_alpha.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{figures/MATH-ALLS-2_ex6_distribution_decay_p3.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\linewidth]{figures/MATH-ALLS-2_ex6_weak_vs_strong_lp_p3.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.8\linewidth]{figures/MATH-ALLS-2_covering_wiener_3B.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.8\linewidth]{figures/MATH-ALLS-2_covering_vitali_5B.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.72\linewidth]{figures/MATH-ALLS-2_two_balls_B_and_3B.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.8\linewidth]{figures/MATH-ALLS-2_weakLp_decay_family.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.8\linewidth]{figures/MATH-ALLS-2_weakLp_integrand_tail.png}
...
Thus $w$ is bounded on $L^{p}$.
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=\textwidth]{figures/MATH-ALLS-2_figureA_dyadic_partition.png}
		\caption{Dyadic partition $E_k=(2^{-k},\,2^{-(k-1)}]$ of $[0,1]$.}
	\end{figure}
	
	\begin{figure}[ht]
		\centering
		\includegraphics[width=\textwidth]{figures/MATH-ALLS-2_figureB_step_function.png}
		\caption{Step function $\phi$ that is $\pm1$ on each $E_k$ (alternating signs shown).}
	\end{figure}
	
	\begin{figure}[ht]
		\centering
		\includegraphics[width=\textwidth]{figures/MATH-ALLS-2_figureC_normalized_indicators.png}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.8\textwidth]{figures/MATH-ALLS-2_figure_lsc_epigraph.png}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.8\textwidth]{figures/MATH-ALLS-2_figure_lsc_strict_inequality.png}
