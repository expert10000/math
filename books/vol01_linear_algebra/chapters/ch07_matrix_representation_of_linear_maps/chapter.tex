...
\end{exercise}
\begin{hint}
Apply the map to a basis of the domain and extract an independent spanning list from the resulting vectors. Multiply the matrix by a coordinate vector only after confirming which basis those coordinates use.
\end{hint}
\begin{solution}
