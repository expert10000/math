...
\begin{problem}[Functions equal a.e. represent the same \(L^p\) element]\label{prob:iii06-dossier-01}
...
\begin{problem}[Finite measure gives \(L^q\subset L^p\)]\label{prob:iii06-dossier-02}
...
\begin{problem}[Essential supremum ignores null spikes]\label{prob:iii06-dossier-03}
...
\begin{problem}[A power singularity test]\label{prob:iii06-dossier-04}
...
\begin{problem}[Norm zero means zero a.e.]\label{prob:iii06-dossier-05}
...
\begin{problem}[An infinite-measure failure of inclusion]\label{prob:iii06-dossier-06}
...
\begin{problem}[Completeness meaning]\label{prob:iii06-dossier-07}
...
\begin{problem}[Probability-space comparison]\label{prob:iii06-dossier-08}
