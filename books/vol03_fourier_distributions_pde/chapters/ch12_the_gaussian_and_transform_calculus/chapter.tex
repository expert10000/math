...
\begin{problem}[The normalized Gaussian is self-dual]\label{prob:iii12-dossier-01}
...
\begin{problem}[Gaussian scaling]\label{prob:iii12-dossier-02}
...
\begin{problem}[Heat-kernel scaling]\label{prob:iii12-dossier-03}
...
\begin{problem}[Moments become frequency derivatives]\label{prob:iii12-dossier-04}
...
\begin{problem}[Gaussian integral]\label{prob:iii12-dossier-05}
...
\begin{problem}[Repeated derivatives]\label{prob:iii12-dossier-06}
...
\begin{problem}[Heat semigroup multiplier]\label{prob:iii12-dossier-07}
...
\begin{problem}[Frequency width]\label{prob:iii12-dossier-08}
