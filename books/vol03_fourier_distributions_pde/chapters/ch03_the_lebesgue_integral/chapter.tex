...
\begin{problem}[Integrating a simple function]\label{prob:iii03-problem-01}
...
\begin{problem}[Positive and negative parts determine integrability]\label{prob:iii03-problem-02}
...
\begin{problem}[Indicators turn measure into integration]\label{prob:iii03-problem-03}
...
\begin{problem}[A nonnegative integral can be infinite]\label{prob:iii03-problem-04}
...
\begin{problem}[Almost-everywhere equality]\label{prob:iii03-problem-05}
...
\begin{problem}[Integral monotonicity]\label{prob:iii03-problem-06}
...
\begin{problem}[Absolute integrability]\label{prob:iii03-problem-07}
...
\begin{problem}[Finite-valued simple approximation]\label{prob:iii03-problem-08}
...
\begin{problem}[Absolute integral inequality]\label{prob:iii03-problem-09}
...
\begin{problem}[Zero integral criterion]\label{prob:iii03-problem-10}
...
\begin{problem}[Linearity]\label{prob:iii03-problem-11}
...
\begin{problem}[Chapter synthesis]\label{prob:iii03-problem-12}
