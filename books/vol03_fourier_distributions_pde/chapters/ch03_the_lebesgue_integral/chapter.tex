...
\end{problem}
\begin{solution}
If measurable $f=g$ almost everywhere and one is integrable, then both are integrable and have the same integral. The decisive point is to use the chapter definition at the correct countable, norm, transform, or distributional level rather than rely on pointwise intuition alone.
\end{solution}
