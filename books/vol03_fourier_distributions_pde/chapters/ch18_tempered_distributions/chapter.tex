...
\begin{problem}[Polynomial growth gives a tempered distribution]\label{prob:iii18-problem-01}
...
\begin{problem}[Dirac mass is tempered]\label{prob:iii18-problem-02}
...
\begin{problem}[A rapidly growing function need not be tempered by integration]\label{prob:iii18-problem-03}
...
\begin{problem}[Differentiation preserves temperedness]\label{prob:iii18-problem-04}
...
\begin{problem}[Constant function]\label{prob:iii18-problem-05}
...
\begin{problem}[Polynomial functions]\label{prob:iii18-problem-06}
...
\begin{problem}[Embedding of compactly supported distributions]\label{prob:iii18-problem-07}
...
\begin{problem}[Schwartz duality]\label{prob:iii18-problem-08}
...
\begin{problem}[Polynomial-growth functions are tempered]\label{prob:iii18-problem-09}
...
\begin{problem}[Derivatives preserve temperedness]\label{prob:iii18-problem-10}
...
\begin{problem}[Polynomial multiplication preserves temperedness]\label{prob:iii18-problem-11}
...
\begin{problem}[Chapter synthesis]\label{prob:iii18-problem-12}
