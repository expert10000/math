...
\end{exercise}
\begin{hint}
Use integrable tail of |hat f|^2.
\end{hint}
\begin{solution}
...
\end{hint}
\begin{solution}
The weight is proportional to |xi|^2.
\end{solution}
...
\end{exercise}
\begin{hint}
Its multiplier is a real indicator with m^2=m.
\end{hint}
\begin{solution}
...
\end{hint}
\begin{solution}
It is an integral of (1+4 pi^2 |xi|^2)|hat f|^2.
\end{solution}
