...
\begin{problem}[Plancherel on a Gaussian]\label{prob:iii13-problem-01}
...
\begin{problem}[Extension from a dense class]\label{prob:iii13-problem-02}
...
\begin{problem}[Energy of a derivative]\label{prob:iii13-problem-03}
...
\begin{problem}[Orthogonality turns convolution into an \(L^2\) tool]\label{prob:iii13-problem-04}
...
\begin{problem}[Parseval polarization]\label{prob:iii13-problem-05}
...
\begin{problem}[Dense-class independence]\label{prob:iii13-problem-06}
...
\begin{problem}[Inverse transform in \(L^2\)]\label{prob:iii13-problem-07}
...
\begin{problem}[Frequency truncation]\label{prob:iii13-problem-08}
...
\begin{problem}[Plancherel theorem]\label{prob:iii13-problem-09}
...
\begin{problem}[Parseval identity]\label{prob:iii13-problem-10}
...
\begin{problem}[$L^2$ multiplier bound]\label{prob:iii13-problem-11}
...
\begin{problem}[Chapter synthesis]\label{prob:iii13-problem-12}
