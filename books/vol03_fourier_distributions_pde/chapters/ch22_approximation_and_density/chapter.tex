...
\begin{problem}[Mollifying a rough function]\label{prob:iii22-problem-01}
...
\begin{problem}[Derivative commutes with mollification]\label{prob:iii22-problem-02}
...
\begin{problem}[Boundary extension is a real issue]\label{prob:iii22-problem-03}
...
\begin{problem}[Smooth functions are dense in \(L^p\)]\label{prob:iii22-problem-04}
...
\begin{problem}[Approximate identity in \(L^p\)]\label{prob:iii22-problem-05}
...
\begin{problem}[Cutoff localization]\label{prob:iii22-problem-06}
...
\begin{problem}[Sobolev density]\label{prob:iii22-problem-07}
...
\begin{problem}[Compact support after mollification]\label{prob:iii22-problem-08}
...
\begin{problem}[$L^p$ mollifier convergence]\label{prob:iii22-problem-09}
...
\begin{problem}[Derivative commutation]\label{prob:iii22-problem-10}
...
\begin{problem}[Density of $C_c^\infty$ in $L^p$]\label{prob:iii22-problem-11}
...
\begin{problem}[Chapter synthesis]\label{prob:iii22-problem-12}
