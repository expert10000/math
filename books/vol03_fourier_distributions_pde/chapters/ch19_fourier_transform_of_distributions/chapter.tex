...
What is the Fourier transform of delta_0 under the chapter convention?
\end{exercise}
\begin{hint}
...
\end{hint}
\begin{solution}
delta_0, with the chapter normalization.
\end{solution}
...
What is the transform of delta_a?
\end{exercise}
\begin{hint}
...
Prove the transform of delta_0 is 1.
\end{exercise}
\begin{hint}
...
Derive the transform of delta_a.
\end{exercise}
\begin{hint}
Evaluate delta_a on the transformed test.
\end{hint}
\begin{solution}
...
\end{hint}
\begin{solution}
It is a constant multiple of the derivative of delta_0, with the sign and 2 pi factor fixed by the chapter convention.
\end{solution}
