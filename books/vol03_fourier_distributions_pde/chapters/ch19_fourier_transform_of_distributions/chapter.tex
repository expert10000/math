...
\begin{problem}[Transform of the Dirac mass]\label{prob:iii19-problem-01}
...
\begin{problem}[Transform of the constant distribution]\label{prob:iii19-problem-02}
...
\begin{problem}[Distributional derivatives obey the same multiplier rule]\label{prob:iii19-problem-03}
...
\begin{problem}[Transform of a translated point mass]\label{prob:iii19-problem-04}
...
\begin{problem}[Laplacian multiplier]\label{prob:iii19-problem-05}
...
\begin{problem}[Multiplication by coordinates]\label{prob:iii19-problem-06}
...
\begin{problem}[Transform is an automorphism]\label{prob:iii19-problem-07}
...
\begin{problem}[PDE motivation]\label{prob:iii19-problem-08}
...
\begin{problem}[Fourier transform of Dirac]\label{prob:iii19-problem-09}
...
\begin{problem}[Derivative rule]\label{prob:iii19-problem-10}
...
\begin{problem}[Fourier automorphism]\label{prob:iii19-problem-11}
...
\begin{problem}[Chapter synthesis]\label{prob:iii19-problem-12}
