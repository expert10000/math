...
\begin{problem}[Egorov needs finite measure]\label{prob:iii08-problem-01}
...
\begin{problem}[\(L^1\)-boundedness is not uniform integrability]\label{prob:iii08-problem-02}
...
\begin{problem}[Uniform integrability repairs convergence]\label{prob:iii08-problem-03}
...
\begin{problem}[A weak-\(L^p\) model singularity]\label{prob:iii08-problem-04}
...
\begin{problem}[Almost-uniform convergence]\label{prob:iii08-problem-05}
...
\begin{problem}[Uniform-integrability tail test]\label{prob:iii08-problem-06}
...
\begin{problem}[Weak-\(L^p\) distribution estimate]\label{prob:iii08-problem-07}
...
\begin{problem}[Convergence in measure from \(L^1\)]\label{prob:iii08-problem-08}
...
\begin{problem}[Egorov theorem]\label{prob:iii08-problem-09}
...
\begin{problem}[Chebyshev inequality]\label{prob:iii08-problem-10}
...
\begin{problem}[Vitali convergence principle]\label{prob:iii08-problem-11}
...
\begin{problem}[Chapter synthesis]\label{prob:iii08-problem-12}
