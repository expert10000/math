...
% VI35-ADDED-EXERCISE-25
\begin{exercise}[Irrelevant torsion disappears]\label{exr:vi35-25}
Let \(M\) be a graded \(S\)-module and suppose \(S_+^N M=0\) for some \(N\). Prove
\[
\widetilde M=0
\quad\text{on }\Proj S.
\]
...
% VI35-ADDED-EXERCISE-26
\begin{exercise}[Domain of a graded map]\label{exr:vi35-26}
Let \(\varphi:S\to T\) be a degree-preserving graded ring map. Show that contraction defines a point of
\(\Proj S\) precisely on
\[
