...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-01 append
Specify \(2\times2\) complex matrices, then separate the orthonormal-column condition \(A^*A=I\) from the determinant-one condition.
\end{hint}
\begin{solution}
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-02 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-03 append
Write the real and imaginary parts of \(\alpha,\beta\). The norm equation gives a sphere, and the matrix parametrization and its inverse are continuous.
\end{hint}
\begin{solution}
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-04 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-05 append
Use the basis \(i,j,k\) and the condition \(\overline v=-v\); this distinguishes the three-dimensional imaginary subspace from all of \(\mathbb H\).
\end{hint}
\begin{solution}
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-06 append
Use a unit quaternion so that \(q^{-1}=\overline q\); check that conjugating an imaginary quaternion leaves it imaginary.
\end{hint}
\begin{solution}
\(R_q(v)=qvq^{-1}\).
\end{solution}
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-07 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-08 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-09 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-10 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-11 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-12 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-13 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-14 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-15 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-16 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-17 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-18 append
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-19 append
For the twice-traversed rotation, insert \(\theta(t)=4\pi t\) and compare the endpoint quaternion with its initial value.
\end{hint}
\begin{solution}
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-20 append
The closed lifted path contracts because the total space \(S^3\) is simply connected. Closedness alone in an arbitrary cover would not prove null-homotopy downstairs.
\end{hint}
\begin{solution}
It is trivial.
\end{solution}
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-21 append
Conjugate elements of the real three-dimensional Lie algebra \(\mathfrak{su}(2)\); an invariant inner product identifies the induced transformations as orthogonal.
\end{hint}
\begin{solution}
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-22 append
Check injectivity of the kernel inclusion, equality of its image with the kernel of the next map, and surjectivity onto \(SO(3)\).
\end{hint}
\begin{solution}
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-23 append
Scalar multiplication commutes with every \(2\times2\) matrix; verify separately that these scalar matrices satisfy the defining conditions of \(SU(2)\).
\end{hint}
\begin{solution}
...
% VIII-PEDAGOGY-HINT-v1.1 exr:viii13-24 append
Compare two universal-cover models: the simply connected three-sphere here and a tree for a connected graph, with their respective deck groups.
\end{hint}
\begin{solution}
