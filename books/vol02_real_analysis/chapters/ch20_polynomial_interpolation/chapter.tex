...
\begin{problem}[Two-point interpolation]\label{prob:ii20-problem-01}
...
\begin{problem}[Three-point Lagrange]\label{prob:ii20-problem-02}
...
\begin{problem}[Uniqueness by roots]\label{prob:ii20-problem-03}
...
\begin{problem}[Lagrange basis property]\label{prob:ii20-problem-04}
...
\begin{problem}[Newton divided difference]\label{prob:ii20-problem-05}
...
\begin{problem}[Incremental interpolation]\label{prob:ii20-problem-06}
...
\begin{problem}[Error node product]\label{prob:ii20-problem-07}
...
\begin{problem}[Linear interpolation error]\label{prob:ii20-problem-08}
...
\begin{problem}[Runge warning]\label{prob:ii20-problem-09}
...
\begin{problem}[Chebyshev motivation]\label{prob:ii20-problem-10}
...
\begin{problem}[Vandermonde formulation]\label{prob:ii20-problem-11}
...
\begin{problem}[Interpolation synthesis]\label{prob:ii20-problem-12}
...
\begin{problem}[Lebesgue amplification]\label{prob:ii20-problem-13}
...
\begin{problem}[Runge phenomenon versus Weierstrass]\label{prob:ii20-problem-14}
