...
\section{Preview: integral equations and ODEs}
% VOL02-DEPENDENCY-PREVIEW-II16-APPLICATIONS
Integral equations and ODEs can be reformulated as fixed-point problems. Chapters~18--19 develop those applications after the abstract contraction theorem is in place.
...
\begin{problem}[Affine contraction]\label{prob:ii16-problem-01}
Solve $x=(x+3)/4$.
\end{problem}
\begin{solution}
...
\begin{problem}[Iteration rate]\label{prob:ii16-problem-02}
...
\begin{problem}[Uniqueness proof]\label{prob:ii16-problem-03}
...
\begin{problem}[Why completeness matters]\label{prob:ii16-problem-04}
...
\begin{problem}[Matrix contraction]\label{prob:ii16-problem-05}
...
\begin{problem}[Fixed-point series]\label{prob:ii16-problem-06}
...
\begin{problem}[A posteriori estimate]\label{prob:ii16-problem-07}
...
\begin{problem}[Nested mapping]\label{prob:ii16-problem-08}
...
\begin{problem}[Parameter stability]\label{prob:ii16-problem-09}
...
\begin{problem}[Integral-equation preview]\label{prob:ii16-problem-10}
...
\begin{problem}[ODE preview]\label{prob:ii16-problem-11}
...
\begin{problem}[Contraction synthesis]\label{prob:ii16-problem-12}
...
% VOL02-HINT-RECONCILIATION-II16
...
\end{exercise}
\begin{hint}
If x and y are fixed points, compare d(x,y)=d(Tx,Ty) with q d(x,y).
\end{hint}
\begin{solution}
...
\end{exercise}
\begin{hint}
The Picard iterates are Cauchy; completeness is exactly what turns that Cauchy sequence into a limit in the space.
\end{hint}
\begin{solution}
