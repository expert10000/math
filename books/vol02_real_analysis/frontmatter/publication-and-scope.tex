...
\textbf{Volume II:} \emph{Real Analysis and Topological Foundations}\\
...
\textbf{Audience.} Readers moving from computational calculus to proof-based analysis.

\textbf{Prerequisites.} Volume I-level mathematical maturity, single-variable calculus, and elementary set theory.
