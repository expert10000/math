...
Resolve Polygonal target by separating assumptions from inference. State the assumptions, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization, give the conclusion, and note one condition under which that conclusion is no longer justified. A polygon is specified by ordered vertices and interior angles $\alpha_k\pi$. The decisive mechanism is to translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{example}

\begin{example}[Derivative form diagnostic]\label{ex:iv18-worked-02}
For Derivative form, begin by isolating the assumptions. Next, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Conclude by stating precisely what has been proved and where the reasoning can break down. For a half-plane map with real prevertices $x_k$, the derivative has factors $(z-x_k)^{\alpha_k-1}$. The decisive mechanism is to translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{example}

\begin{example}[Turning angles diagnostic]\label{ex:iv18-worked-03}
Audit Turning angles in four stages: hypotheses, decisive mechanism, argument, and limitation. For the decisive mechanism, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. The exponent $\alpha_k-1$ records the change of boundary direction at the corresponding vertex. The decisive mechanism is to translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{example}

\begin{example}[Integration diagnostic]\label{ex:iv18-worked-04}
For Integration, begin by isolating the assumptions. Next, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Conclude by stating precisely what has been proved and where the reasoning can break down. The conformal map is obtained by integrating the Schwarz–Christoffel derivative and adding affine constants. The decisive mechanism is to translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{example}
...
\begin{problem}[Polygonal target diagnostic]\label{prob:iv18-problem-01}
Resolve Polygonal target by separating assumptions from inference. State the assumptions, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization, give the conclusion, and note one condition under which that conclusion is no longer justified.
\end{problem}
\begin{solution}
A polygon is specified by ordered vertices and interior angles $\alpha_k\pi$. The decisive mechanism is to translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Its hypotheses must be checked before the conclusion is transported to a new setting.
...
\begin{problem}[Derivative form diagnostic]\label{prob:iv18-problem-02}
For Derivative form, begin by isolating the assumptions. Next, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Conclude by stating precisely what has been proved and where the reasoning can break down.
\end{problem}
\begin{solution}
For a half-plane map with real prevertices $x_k$, the derivative has factors $(z-x_k)^{\alpha_k-1}$. The decisive mechanism is to translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}

\begin{problem}[Turning angles diagnostic]\label{prob:iv18-problem-03}
Audit Turning angles in four stages: hypotheses, decisive mechanism, argument, and limitation. For the decisive mechanism, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization.
\end{problem}
\begin{solution}
The exponent $\alpha_k-1$ records the change of boundary direction at the corresponding vertex. The decisive mechanism is to translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}

\begin{problem}[Integration diagnostic]\label{prob:iv18-problem-04}
For Integration, begin by isolating the assumptions. Next, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Conclude by stating precisely what has been proved and where the reasoning can break down.
\end{problem}
\begin{solution}
The conformal map is obtained by integrating the Schwarz–Christoffel derivative and adding affine constants. The decisive mechanism is to translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}

\begin{problem}[Prevertices diagnostic]\label{prob:iv18-problem-05}
For Prevertices, begin by isolating the assumptions. Next, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Conclude by stating precisely what has been proved and where the reasoning can break down.
\end{problem}
\begin{solution}
Determining the prevertices is the accessory-parameter problem and is generally nonlinear. The decisive mechanism is to translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}

\begin{problem}[Normalization diagnostic]\label{prob:iv18-problem-06}
Audit Normalization in four stages: hypotheses, decisive mechanism, argument, and limitation. For the decisive mechanism, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization.
\end{problem}
\begin{solution}
Three real degrees of freedom can be fixed by half-plane Möbius automorphisms. The decisive mechanism is to translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}

\begin{problem}[Rectangles diagnostic]\label{prob:iv18-problem-07}
Resolve Rectangles by separating assumptions from inference. State the assumptions, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization, give the conclusion, and note one condition under which that conclusion is no longer justified.
\end{problem}
\begin{solution}
Symmetry reduces rectangle maps to elliptic integrals. The decisive mechanism is to translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}

\begin{problem}[Slits and degenerate polygons diagnostic]\label{prob:iv18-problem-08}
For Slits and degenerate polygons, begin by isolating the assumptions. Next, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Conclude by stating precisely what has been proved and where the reasoning can break down.
\end{problem}
\begin{solution}
Limiting polygon configurations produce maps to slit domains and strips. The decisive mechanism is to translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}

\begin{problem}[Angle-exponent relation]\label{prob:iv18-problem-09}
...
\end{problem}
\begin{solution}
Integrating gives local behavior $F(z)-F(x_k)\sim C(z-x_k)^{\alpha_k}$. The argument is therefore multiplied by $\alpha_k$, sending the half-plane angle $\pi$ to $\alpha_k\pi$. The proof hinges on the following step: translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization.
\end{solution}

\begin{problem}[Sum of exponents]\label{prob:iv18-problem-10}
Prove the following theorem-level statement and identify the essential hypothesis: For an $n$-gon, $\sum_{k=1}^n(\alpha_k-1)=-2$.
\end{problem}
\begin{solution}
The interior-angle sum is $(n-2)\pi$, so $\sum\alpha_k=n-2$ and subtraction of $n$ gives $-2$. The proof hinges on the following step: translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization.
\end{solution}

\begin{problem}[Affine freedom]\label{prob:iv18-problem-11}
...
\end{problem}
\begin{solution}
Their derivatives are proportional by the chosen normalization, so integration yields $F_2=A F_1+B$ with $A\ne0$. The proof hinges on the following step: translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization.
\end{solution}

\begin{problem}[Chapter synthesis]\label{prob:iv18-problem-12}
...
Work through Polygonal target from the assumptions outward. Under the stated hypotheses, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Give the resulting conclusion and one boundary case where the argument no longer applies.
\end{exercise}
\begin{hint}
...
Work through Derivative form from the assumptions outward. Under the stated hypotheses, translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Give the resulting conclusion and one boundary case where the argument no longer applies.
\end{exercise}
\begin{hint}
...
Determine which hypotheses are actually needed for Turning angles. Then translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. State the conclusion and identify what can fail when one essential hypothesis is removed.
\end{exercise}
\begin{hint}
...
For Integration, distinguish the formal setup from the decisive step. First record the hypotheses; then translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. Explain the conclusion and a failure mode outside those hypotheses.
\end{exercise}
\begin{hint}
...
Determine which hypotheses are actually needed for Prevertices. Then translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. State the conclusion and identify what can fail when one essential hypothesis is removed.
\end{exercise}
\begin{hint}
...
Use Normalization as a hypothesis audit. List the assumptions, then translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. State exactly what follows and what the argument would cease to control if an assumption were dropped.
\end{exercise}
\begin{hint}
...
Use Rectangles as a hypothesis audit. List the assumptions, then translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. State exactly what follows and what the argument would cease to control if an assumption were dropped.
\end{exercise}
\begin{hint}
...
Determine which hypotheses are actually needed for Slits and degenerate polygons. Then translate polygon angles into Schwarz--Christoffel exponents and fix the affine constants from geometric normalization. State the conclusion and identify what can fail when one essential hypothesis is removed.
\end{exercise}
\begin{hint}
