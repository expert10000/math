...
For Removable singularities, begin by isolating the assumptions. Next, read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Conclude by stating precisely what has been proved and where the reasoning can break down. A bounded holomorphic function on a punctured neighborhood extends holomorphically across the puncture. The decisive mechanism is to read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{example}

\begin{example}[Poles diagnostic]\label{ex:iv09-worked-02}
Resolve Poles by separating assumptions from inference. State the assumptions, read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities, give the conclusion, and note one condition under which that conclusion is no longer justified. A pole of order $m$ is characterized by $(z-z_0)^mf(z)$ extending holomorphically and nonzero at $z_0$. The decisive mechanism is to read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{example}

\begin{example}[Essential singularities diagnostic]\label{ex:iv09-worked-03}
Resolve Essential singularities by separating assumptions from inference. State the assumptions, read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities, give the conclusion, and note one condition under which that conclusion is no longer justified. An essential singularity has infinitely many negative Laurent coefficients. The decisive mechanism is to read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{example}

\begin{example}[Classification theorem diagnostic]\label{ex:iv09-worked-04}
Treat Classification theorem as a short proof dossier. State the hypotheses explicitly, then read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Derive the conclusion and identify a failure mode if a required hypothesis is absent. Every isolated singularity is exactly one of removable, pole, or essential. The decisive mechanism is to read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{example}
...
For Removable singularities, begin by isolating the assumptions. Next, read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Conclude by stating precisely what has been proved and where the reasoning can break down.
\end{problem}
\begin{solution}
A bounded holomorphic function on a punctured neighborhood extends holomorphically across the puncture. The decisive mechanism is to read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}

\begin{problem}[Poles diagnostic]\label{prob:iv09-problem-02}
Resolve Poles by separating assumptions from inference. State the assumptions, read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities, give the conclusion, and note one condition under which that conclusion is no longer justified.
\end{problem}
\begin{solution}
A pole of order $m$ is characterized by $(z-z_0)^mf(z)$ extending holomorphically and nonzero at $z_0$. The decisive mechanism is to read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}
...
Treat Classification theorem as a short proof dossier. State the hypotheses explicitly, then read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Derive the conclusion and identify a failure mode if a required hypothesis is absent.
\end{problem}
\begin{solution}
Every isolated singularity is exactly one of removable, pole, or essential. The decisive mechanism is to read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}
...
For Riemann removable theorem, begin by isolating the assumptions. Next, read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Conclude by stating precisely what has been proved and where the reasoning can break down.
\end{problem}
\begin{solution}
Boundedness near the puncture is enough for removability. The decisive mechanism is to read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}

\begin{problem}[Casorati--Weierstrass diagnostic]\label{prob:iv09-problem-06}
Audit Casorati--Weierstrass in four stages: hypotheses, decisive mechanism, argument, and limitation. For the decisive mechanism, read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities.
\end{problem}
\begin{solution}
Near an essential singularity the image is dense in the complex plane. The decisive mechanism is to read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}

\begin{problem}[Behavior of reciprocals diagnostic]\label{prob:iv09-problem-07}
Resolve Behavior of reciprocals by separating assumptions from inference. State the assumptions, read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities, give the conclusion, and note one condition under which that conclusion is no longer justified.
\end{problem}
\begin{solution}
Zeros of a holomorphic function correspond to poles of its reciprocal, with matching order. The decisive mechanism is to read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}

\begin{problem}[Singularity at infinity diagnostic]\label{prob:iv09-problem-08}
For Singularity at infinity, begin by isolating the assumptions. Next, read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Conclude by stating precisely what has been proved and where the reasoning can break down.
\end{problem}
\begin{solution}
Use $w=1/z$ to classify behavior at infinity for functions on exterior domains. The decisive mechanism is to read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Its hypotheses must be checked before the conclusion is transported to a new setting.
\end{solution}
...
\end{problem}
\begin{solution}
Use Cauchy's formula on a punctured annulus and estimate negative Laurent coefficients; boundedness forces every negative coefficient to vanish. The proof hinges on the following step: read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities.
\end{solution}
...
\end{problem}
\begin{solution}
Factor $f=(z-z_0)^mg$ with $g(z_0)\ne0$ and invert to obtain $(1/f)=(z-z_0)^{-m}(1/g)$ with holomorphic nonvanishing factor. The proof hinges on the following step: read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities.
\end{solution}
...
Use Removable singularities as a hypothesis audit. List the assumptions, then read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. State exactly what follows and what the argument would cease to control if an assumption were dropped.
\end{exercise}
\begin{hint}
...
For Poles, distinguish the formal setup from the decisive step. First record the hypotheses; then read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Explain the conclusion and a failure mode outside those hypotheses.
\end{exercise}
\begin{hint}
...
Work through Essential singularities from the assumptions outward. Under the stated hypotheses, read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. Give the resulting conclusion and one boundary case where the argument no longer applies.
\end{exercise}
\begin{hint}
...
Determine which hypotheses are actually needed for Classification theorem. Then read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. State the conclusion and identify what can fail when one essential hypothesis is removed.
\end{exercise}
\begin{hint}
...
Use Riemann removable theorem as a hypothesis audit. List the assumptions, then read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. State exactly what follows and what the argument would cease to control if an assumption were dropped.
\end{exercise}
\begin{hint}
...
Determine which hypotheses are actually needed for Casorati--Weierstrass. Then read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. State the conclusion and identify what can fail when one essential hypothesis is removed.
\end{exercise}
\begin{hint}
...
Use Behavior of reciprocals as a hypothesis audit. List the assumptions, then read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. State exactly what follows and what the argument would cease to control if an assumption were dropped.
\end{exercise}
\begin{hint}
...
Determine which hypotheses are actually needed for Singularity at infinity. Then read the principal part of the Laurent expansion and distinguish removable points, poles, and essential singularities. State the conclusion and identify what can fail when one essential hypothesis is removed.
\end{exercise}
\begin{hint}
