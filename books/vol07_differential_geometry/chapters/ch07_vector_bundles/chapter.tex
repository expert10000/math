...
\begin{problem}[Vector-bundle problem: local triviality]\label{prob:vii07-01}
...
\begin{problem}[Vector-bundle problem: cocycles]\label{prob:vii07-02}
...
\begin{problem}[Tangent-bundle problem]\label{prob:vii07-03}
...
\begin{problem}[Cotangent-bundle problem]\label{prob:vii07-04}
...
\begin{problem}[Sections problem]\label{prob:vii07-05}
...
\begin{problem}[Triviality problem]\label{prob:vii07-06}
...
\begin{problem}[Möbius bundle]\label{prob:vii07-07}
...
\begin{problem}[Bundle-map]\label{prob:vii07-08}
...
\begin{problem}[Constant-rank kernel]\label{prob:vii07-09}
...
\begin{problem}[Dual-bundle]\label{prob:vii07-10}
...
\begin{problem}[Pullback]\label{prob:vii07-11}
...
\begin{problem}[Tangent subbundle]\label{prob:vii07-12}
