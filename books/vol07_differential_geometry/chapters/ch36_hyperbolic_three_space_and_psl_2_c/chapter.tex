...
Give the set and metric. Make the controlling geometric criterion explicit before the calculation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Take the determinant of the conformal metric. Work in a convenient local model first, then return to the invariant statement. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the Euclidean separation divided by heights. After the main computation, check the hypotheses and geometric interpretation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use Euclidean objects orthogonal to the boundary. Make the controlling geometric criterion explicit before the calculation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Raise the dimension of the geodesic description by one. Work in a convenient local model first, then return to the invariant statement. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Compactify the boundary plane by infinity. After the main computation, check the hypotheses and geometric interpretation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use a level set of height. Make the controlling geometric criterion explicit before the calculation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Think of Euclidean spheres tangent to the boundary. Work in a convenient local model first, then return to the invariant statement. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use three plus signs and one minus sign. After the main computation, check the hypotheses and geometric interpretation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Take the upper unit timelike sheet. Make the controlling geometric criterion explicit before the calculation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the Lorentz inner product. Work in a convenient local model first, then return to the invariant statement. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use fractional linear transformation. After the main computation, check the hypotheses and geometric interpretation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Both numerator and denominator change sign. Make the controlling geometric criterion explicit before the calculation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the extension theorem. Work in a convenient local model first, then return to the invariant statement. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use its normal form. After the main computation, check the hypotheses and geometric interpretation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
There is a unique geodesic with given ideal endpoints. Make the controlling geometric criterion explicit before the calculation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Complex length has real and imaginary parts. Work in a convenient local model first, then return to the invariant statement. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Separate translation and rotation. After the main computation, check the hypotheses and geometric interpretation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use determinant one. Make the controlling geometric criterion explicit before the calculation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Add the two eigenvalues. Work in a convenient local model first, then return to the invariant statement. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Rotational data are complex. After the main computation, check the hypotheses and geometric interpretation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Real coefficients preserve the real projective line. Make the controlling geometric criterion explicit before the calculation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Take the totally geodesic plane with that ideal boundary. Work in a convenient local model first, then return to the invariant statement. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Change the ambient group but keep discreteness. After the main computation, check the hypotheses and geometric interpretation. Use the upper-half-space or ball model in three dimensions and the complex fractional-linear action to connect boundary Mobius geometry with interior isometries.
\end{hint}
