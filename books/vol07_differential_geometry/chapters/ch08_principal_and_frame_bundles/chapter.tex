...
\begin{problem}[Principal-bundle problem: torsors]\label{prob:vii08-01}
...
\begin{problem}[Local-section problem]\label{prob:vii08-02}
...
\begin{problem}[Transition-function problem]\label{prob:vii08-03}
...
\begin{problem}[Frame-bundle problem]\label{prob:vii08-04}
...
\begin{problem}[Tangent-frame]\label{prob:vii08-05}
...
\begin{problem}[Global-section]\label{prob:vii08-06}
...
\begin{problem}[Associated-bundle]\label{prob:vii08-07}
...
\begin{problem}[Gauge-change]\label{prob:vii08-09}
...
\begin{problem}[Equivariant-map]\label{prob:vii08-10}
