...
Apply Leibniz to \(1\cdot1\). Make the controlling geometric criterion explicit before the calculation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Check linearity and Leibniz. Work in a convenient local model first, then return to the invariant statement. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the ordinary product rule. After the main computation, check the hypotheses and geometric interpretation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate a coordinate function. Make the controlling geometric criterion explicit before the calculation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
It equals \(\delta_i^j\).
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Evaluate on every \(x^j\). Work in a convenient local model first, then return to the invariant statement. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use a coordinate basis. After the main computation, check the hypotheses and geometric interpretation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate the transition map. Make the controlling geometric criterion explicit before the calculation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate the transition map. Work in a convenient local model first, then return to the invariant statement. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate \((fg)\circ\gamma\). After the main computation, check the hypotheses and geometric interpretation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use a straight line in coordinates. Make the controlling geometric criterion explicit before the calculation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Compute the Jacobian. Work in a convenient local model first, then return to the invariant statement. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Evaluate on a test function. After the main computation, check the hypotheses and geometric interpretation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Pull products back by \(F\). Make the controlling geometric criterion explicit before the calculation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Test both sides on a smooth function. Work in a convenient local model first, then return to the invariant statement. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Pulled-back functions are constant. After the main computation, check the hypotheses and geometric interpretation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Evaluate on test functions. Make the controlling geometric criterion explicit before the calculation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate both inverse identities. Work in a convenient local model first, then return to the invariant statement. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use \(\det[dF]=r\). After the main computation, check the hypotheses and geometric interpretation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
The rank is \(2\) for \(r\ne0\) and \(1\) at \(r=0\).
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate the inclusion. Make the controlling geometric criterion explicit before the calculation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate the projection. Work in a convenient local model first, then return to the invariant statement. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use a periodic parametrization. After the main computation, check the hypotheses and geometric interpretation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use curve compatibility. Make the controlling geometric criterion explicit before the calculation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the differential definition. Work in a convenient local model first, then return to the invariant statement. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
\(df_p(v)=v(f)\).
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Coordinate changes give invertible factors. After the main computation, check the hypotheses and geometric interpretation. Represent tangent vectors by curve velocities or derivations and use the chart differential only as a coordinate model of the intrinsic tangent space.
\end{hint}
\begin{solution}
