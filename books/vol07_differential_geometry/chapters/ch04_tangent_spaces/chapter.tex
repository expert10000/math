...
\begin{problem}[Tangent-space problem: derivations]\label{prob:vii04-01}
...
\begin{problem}[Tangent-space problem: curve classes]\label{prob:vii04-02}
...
\begin{problem}[Differential problem]\label{prob:vii04-03}
