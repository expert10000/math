...
Differentiate an inner product.
\end{hint}
\begin{solution}
It is \(Xg(Y,Z)=g(\nabla_XY,Z)+g(Y,\nabla_XZ)\).
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
The metric coefficients are constant.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Connection coefficients are not tensor components.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate \(g_{\theta\theta}=r^2\).
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the Euclidean product rule.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Split ambient derivative into tangent and normal parts.
\end{hint}
\begin{solution}
\(D_XY=\nabla_XY+II(X,Y)N\).
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate the gradient covariantly.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Expand using metric compatibility.
\end{hint}
\begin{solution}
