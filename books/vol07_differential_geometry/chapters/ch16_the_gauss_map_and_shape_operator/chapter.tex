...
angle=1\). Make the controlling geometric criterion explicit before the calculation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the defining property of the cross product. Work in a convenient local model first, then return to the invariant statement. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Interchange \(u\) and \(v\). After the main computation, check the hypotheses and geometric interpretation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Check smoothness and norm. Make the controlling geometric criterion explicit before the calculation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Its normal is constant. Work in a convenient local model first, then return to the invariant statement. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use \(N(p)=p/R\). After the main computation, check the hypotheses and geometric interpretation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Replace \(N\) by \(-N\). Make the controlling geometric criterion explicit before the calculation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Move parallel to the axis. Work in a convenient local model first, then return to the invariant statement. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
angle=0\). After the main computation, check the hypotheses and geometric interpretation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Write the previous bilinear identity in matrix form. Make the controlling geometric criterion explicit before the calculation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use linear independence of \(X_u,X_v\). Work in a convenient local model first, then return to the invariant statement. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use symmetry of \(II\). After the main computation, check the hypotheses and geometric interpretation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Apply self-adjointness. Make the controlling geometric criterion explicit before the calculation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use \(II(v,v)=I(Sv,v)\). Work in a convenient local model first, then return to the invariant statement. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Both numerator and denominator are quadratic. After the main computation, check the hypotheses and geometric interpretation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
The shape operator changes sign. Make the controlling geometric criterion explicit before the calculation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the definition. Work in a convenient local model first, then return to the invariant statement. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Think about \(dN_p(v)\). After the main computation, check the hypotheses and geometric interpretation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Insert \(Se=ke\). Make the controlling geometric criterion explicit before the calculation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
The tangent plane is a Euclidean inner-product space. Work in a convenient local model first, then return to the invariant statement. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate normal orthogonality. After the main computation, check the hypotheses and geometric interpretation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
angle\) in \(u\). Make the controlling geometric criterion explicit before the calculation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
All tangent planes have the same normal line. Work in a convenient local model first, then return to the invariant statement. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use its two eigenvalues. After the main computation, check the hypotheses and geometric interpretation. Differentiate the unit normal to obtain the shape operator, then use its eigenvectors and eigenvalues to read principal directions and curvatures.
\end{hint}
\begin{solution}
