...
\begin{problem}[Gauss-map problem]\label{prob:vii16-01}
...
\begin{problem}[Shape-operator problem]\label{prob:vii16-02}
...
\begin{problem}[Weingarten problem]\label{prob:vii16-03}
