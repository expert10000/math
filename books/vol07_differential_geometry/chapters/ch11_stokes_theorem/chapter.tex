...
\begin{problem}[Stokes problem: interval]\label{prob:vii11-01}
...
\begin{problem}[Stokes problem: planar Green theorem]\label{prob:vii11-02}
...
\begin{problem}[Stokes problem: boundary orientation]\label{prob:vii11-03}
