...
Use the half-line model. Make the controlling geometric criterion explicit before the calculation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Restrict a boundary chart to $x^n=0$. Work in a convenient local model first, then return to the invariant statement. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use outward-normal-first. After the main computation, check the hypotheses and geometric interpretation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Test at $(1,0)$. Make the controlling geometric criterion explicit before the calculation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Include the boundary pullback. Work in a convenient local model first, then return to the invariant statement. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Take a $0$-form $f$ on an interval. After the main computation, check the hypotheses and geometric interpretation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use $d(f\alpha)=df\wedge\alpha$. Make the controlling geometric criterion explicit before the calculation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the preceding one-form. Work in a convenient local model first, then return to the invariant statement. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use equality of mixed partials. After the main computation, check the hypotheses and geometric interpretation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Apply $d$ twice. Make the controlling geometric criterion explicit before the calculation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Apply Stokes. Work in a convenient local model first, then return to the invariant statement. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate the one-form over the disk. After the main computation, check the hypotheses and geometric interpretation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Expand the exterior derivative. Make the controlling geometric criterion explicit before the calculation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
The corresponding one-form is exact. Work in a convenient local model first, then return to the invariant statement. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate each coefficient. After the main computation, check the hypotheses and geometric interpretation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use $\omega=\iota_XdV$. Make the controlling geometric criterion explicit before the calculation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Track induced boundary orientation too. Work in a convenient local model first, then return to the invariant statement. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Connect the vectors through the outward half-space. After the main computation, check the hypotheses and geometric interpretation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Integrate over $S^2$. Make the controlling geometric criterion explicit before the calculation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Outward normals point opposite ways on the two circles. Work in a convenient local model first, then return to the invariant statement. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Their support avoids the boundary. After the main computation, check the hypotheses and geometric interpretation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Prevent terms at infinity. Make the controlling geometric criterion explicit before the calculation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Apply Stokes on $\partial M$. Work in a convenient local model first, then return to the invariant statement. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Pair Stokes twice. After the main computation, check the hypotheses and geometric interpretation. Identify the oriented boundary first, then compare the exterior derivative integral in the interior with the induced boundary integral and its sign convention.
\end{hint}
\begin{solution}
