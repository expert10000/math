...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Rank two means two independent columns.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the level-set function \(F(x)=\|x\|^2\).
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Compute its coordinate derivatives.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Look at the first two components of \(X_u,X_v\).
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Opposite parameter edges represent the same points.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate in the angular coordinate.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use a nonzero component of the normal.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the patch derivative image.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Compare local topology or tangent behavior.
\end{hint}
\begin{solution}
...
\begin{problem}[Regular-patch problem]\label{prob:vii14-01}
...
\begin{problem}[Tangent-plane problem]\label{prob:vii14-02}
...
\begin{problem}[Graph problem]\label{prob:vii14-03}
...
\begin{problem}[Implicit-surface problem]\label{prob:vii14-04}
...
\begin{problem}[Sphere atlas]\label{prob:vii14-05}
...
\begin{problem}[Cylinder]\label{prob:vii14-06}
...
\begin{problem}[Change-of-parameters]\label{prob:vii14-07}
...
\begin{problem}[Surface-of-revolution]\label{prob:vii14-08}
...
\begin{problem}[Torus]\label{prob:vii14-09}
...
\begin{problem}[Helicoid]\label{prob:vii14-10}
...
\begin{problem}[Overlap-map]\label{prob:vii14-11}
