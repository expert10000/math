...
\[
d_E
\quad\text{(edge-graph distance)},\qquad
d_M
\quad\text{(exact polyhedral distance)},\qquad
d_{\mathrm{smooth}}
\quad\text{(distance on an intended smooth limit surface)}.
\]
...
\;\longrightarrow\;
\text{exact polyhedral reference cases}
\;\longrightarrow\;
\text{mesh-refinement studies}
\;\longrightarrow\;
\text{application meshes}.
\]
