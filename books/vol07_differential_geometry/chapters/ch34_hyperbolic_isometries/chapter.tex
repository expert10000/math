...
Cross multiply. Make the controlling geometric criterion explicit before the calculation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
\(cz^2+(d-a)z-b=0\).
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Simplify \((d-a)^2+4bc\). Work in a convenient local model first, then return to the invariant statement. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
\((\operatorname{tr}A)^2-4\).
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the trace trichotomy. After the main computation, check the hypotheses and geometric interpretation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
It is elliptic.
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the trace trichotomy. Make the controlling geometric criterion explicit before the calculation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
It is parabolic.
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the trace trichotomy. Work in a convenient local model first, then return to the invariant statement. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
It is hyperbolic.
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
\(A\) and \(-A\) are identical projectively. After the main computation, check the hypotheses and geometric interpretation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Look inside the half-plane. Make the controlling geometric criterion explicit before the calculation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Discriminant zero. Work in a convenient local model first, then return to the invariant statement. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
Exactly one.
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Discriminant positive. After the main computation, check the hypotheses and geometric interpretation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
Exactly two.
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Move its fixed point to infinity. Make the controlling geometric criterion explicit before the calculation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
\(z\mapsto z+1\).
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Move its fixed points to \(0,\infty\). Work in a convenient local model first, then return to the invariant statement. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Join its two ideal fixed points. After the main computation, check the hypotheses and geometric interpretation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the normal form. Make the controlling geometric criterion explicit before the calculation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Take the infimum displacement. Work in a convenient local model first, then return to the invariant statement. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
\(\tau(g)=\inf_z d(z,gz)\).
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
It has an interior fixed point. After the main computation, check the hypotheses and geometric interpretation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
It has no interior fixed point. Make the controlling geometric criterion explicit before the calculation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use its axis. Work in a convenient local model first, then return to the invariant statement. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use \(\cosh(\tau/2)\). After the main computation, check the hypotheses and geometric interpretation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use north--south dynamics. Make the controlling geometric criterion explicit before the calculation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Reverse the roles. Work in a convenient local model first, then return to the invariant statement. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Require its angle to be rational relative to \(\pi\). After the main computation, check the hypotheses and geometric interpretation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Conjugation preserves fixed points/trace. Make the controlling geometric criterion explicit before the calculation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
Yes.
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Think reflection. Work in a convenient local model first, then return to the invariant statement. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Pass from single elements to discrete subgroups. After the main computation, check the hypotheses and geometric interpretation. Classify an isometry from its fixed points and translation data, then connect the algebraic type with its geometric action on the hyperbolic plane.
\end{hint}
\begin{solution}
