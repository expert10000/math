...
Use eigenvalues. Make the controlling geometric criterion explicit before the calculation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use an orthonormal eigenbasis. Work in a convenient local model first, then return to the invariant statement. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use self-adjointness. After the main computation, check the hypotheses and geometric interpretation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the eigenvalues. Make the controlling geometric criterion explicit before the calculation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the eigenvalues. Work in a convenient local model first, then return to the invariant statement. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Both eigenvalues change sign. After the main computation, check the hypotheses and geometric interpretation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Both eigenvalues change sign. Make the controlling geometric criterion explicit before the calculation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use \(\det(I^{-1}II)\). Work in a convenient local model first, then return to the invariant statement. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Compute the trace of \(I^{-1}II\). After the main computation, check the hypotheses and geometric interpretation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the sign classification. Make the controlling geometric criterion explicit before the calculation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
It is hyperbolic.
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the sign classification. Work in a convenient local model first, then return to the invariant statement. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
It is elliptic.
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
One principal curvature vanishes. After the main computation, check the hypotheses and geometric interpretation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
It is parabolic.
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Its shape operator vanishes. Make the controlling geometric criterion explicit before the calculation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Its shape operator is a scalar multiple of the identity. Work in a convenient local model first, then return to the invariant statement. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Expand both sides. After the main computation, check the hypotheses and geometric interpretation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the previous identity. Make the controlling geometric criterion explicit before the calculation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Set the square to zero. Work in a convenient local model first, then return to the invariant statement. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use normal curvature. After the main computation, check the hypotheses and geometric interpretation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Principal curvatures have opposite signs. Make the controlling geometric criterion explicit before the calculation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Principal curvatures have the same nonzero sign. Work in a convenient local model first, then return to the invariant statement. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
One principal curvature is zero. After the main computation, check the hypotheses and geometric interpretation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Both principal curvatures vanish. Make the controlling geometric criterion explicit before the calculation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use \(\det dN\). Work in a convenient local model first, then return to the invariant statement. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use \(K=0\). After the main computation, check the hypotheses and geometric interpretation. Diagonalize the shape operator at the point when possible; Gaussian curvature is the product and mean curvature is the averaged trace of its principal curvatures.
\end{hint}
\begin{solution}
