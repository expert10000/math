...
Choose source and target charts.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Factor through transition maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
It is a transition map in coordinates.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Coordinate representatives are constant.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Check each point in one cover member.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the Euclidean componentwise criterion.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use identity, inverse, composition.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Restrict coordinate representatives.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate inverse identities.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
All maximal charts are compatible with it.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Smooth maps have first-order linearizations.
\end{hint}
\begin{solution}
...
\begin{problem}[Supplementary Problem 3: local chart criterion]\label{prob:vii03-01}
...
\begin{problem}[Diffeomorphism problem: ball to space]\label{prob:vii03-02}
...
\begin{problem}[Consequence: full-space charts]\label{prob:vii03-03}
Show every point of a smooth \(k\)-manifold admits a chart onto all of \(\mathbb R^k\).
\end{problem}
\begin{solution}
Shrink any chart to a coordinate ball and compose with the ball diffeomorphism.
\end{solution}

\begin{problem}[Dimension obstruction]\label{prob:vii03-04}
