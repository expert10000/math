...
Compare \((n,0)\) with index one. Make the controlling geometric criterion explicit before the calculation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the Levi--Civita machinery. Work in a convenient local model first, then return to the invariant statement. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Consider timelike and null vectors. After the main computation, check the hypotheses and geometric interpretation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Insert a minus sign under the square root. Make the controlling geometric criterion explicit before the calculation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Its tangent has zero norm-square. Work in a convenient local model first, then return to the invariant statement. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
It is zero.
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Classify its tangent. After the main computation, check the hypotheses and geometric interpretation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Choose one timelike cone continuously. Make the controlling geometric criterion explicit before the calculation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use a timelike vector field. Work in a convenient local model first, then return to the invariant statement. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Allow timelike or null tangents. After the main computation, check the hypotheses and geometric interpretation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use timelike curves. Make the controlling geometric criterion explicit before the calculation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Allow causal curves. Work in a convenient local model first, then return to the invariant statement. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use mostly-plus convention. After the main computation, check the hypotheses and geometric interpretation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
It is timelike.
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the light cone. Make the controlling geometric criterion explicit before the calculation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
It is null.
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use causal type. Work in a convenient local model first, then return to the invariant statement. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
It is spacelike.
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate \(g(\dot\gamma,\dot\gamma)\). After the main computation, check the hypotheses and geometric interpretation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Index one leaves no negative direction. Make the controlling geometric criterion explicit before the calculation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Notice \(v\perp v\). Work in a convenient local model first, then return to the invariant statement. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Future and past differ. After the main computation, check the hypotheses and geometric interpretation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Think proper-time maximization. Make the controlling geometric criterion explicit before the calculation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Compare length and proper time. Work in a convenient local model first, then return to the invariant statement. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
There is no positive-definite distance from the Lorentzian metric. After the main computation, check the hypotheses and geometric interpretation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Restrict to nondegenerate two-planes. Make the controlling geometric criterion explicit before the calculation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Recall Minkowski space. Work in a convenient local model first, then return to the invariant statement. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Move from Lorentzian ambient space to a Riemannian submanifold. After the main computation, check the hypotheses and geometric interpretation. Compare the same connection and curvature constructions under positive-definite and Lorentzian signatures, noting where causal cones replace ordinary metric spheres.
\end{hint}
\begin{solution}
