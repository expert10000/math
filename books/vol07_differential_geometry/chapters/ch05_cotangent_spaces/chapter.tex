...
\begin{problem}[Cotangent problem: dual basis]\label{prob:vii05-01}
...
\begin{problem}[Differential problem: \(df\)]\label{prob:vii05-02}
...
\begin{problem}[Covector problem: transformation law]\label{prob:vii05-03}
