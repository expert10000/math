...
Use finite-dimensional duality. Make the controlling geometric criterion explicit before the calculation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the definition of coordinate derivations. Work in a convenient local model first, then return to the invariant statement. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the dual-basis theorem. After the main computation, check the hypotheses and geometric interpretation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Identify \(T_{f(p)}\mathbb R\) with \(\mathbb R\). Make the controlling geometric criterion explicit before the calculation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Take partial derivatives. Work in a convenient local model first, then return to the invariant statement. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Apply a tangent derivation. After the main computation, check the hypotheses and geometric interpretation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the derivation Leibniz rule. Make the controlling geometric criterion explicit before the calculation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Apply the formula for \(d(y^a)\). Work in a convenient local model first, then return to the invariant statement. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Combine the dual transformation laws. After the main computation, check the hypotheses and geometric interpretation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use linearity of a covector. Make the controlling geometric criterion explicit before the calculation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Evaluate on a tangent vector. Work in a convenient local model first, then return to the invariant statement. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Evaluate on a tangent vector. After the main computation, check the hypotheses and geometric interpretation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Compute \(d(u\circ F)\) and \(d(v\circ F)\). Make the controlling geometric criterion explicit before the calculation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the dual standard basis. Work in a convenient local model first, then return to the invariant statement. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Extend a basis and dualize. After the main computation, check the hypotheses and geometric interpretation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Evaluate \(A^*\alpha\) on \(v\in\ker A\). Make the controlling geometric criterion explicit before the calculation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Compare dimensions after proving inclusion. Work in a convenient local model first, then return to the invariant statement. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use linear duality. After the main computation, check the hypotheses and geometric interpretation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use linear duality. Make the controlling geometric criterion explicit before the calculation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Solve \(df=0\). Work in a convenient local model first, then return to the invariant statement. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Write the differential. After the main computation, check the hypotheses and geometric interpretation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
It is \(\{v:p\cdot v=0\}\).
\end{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
A covector-to-vector identification is missing. Make the controlling geometric criterion explicit before the calculation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use nondegeneracy of the inner product. Work in a convenient local model first, then return to the invariant statement. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Think of \(\ker dF_p\). After the main computation, check the hypotheses and geometric interpretation. Pair covectors with tangent vectors and track pullback by composition with the differential; duality reverses the direction of maps.
\end{hint}
\begin{solution}
