...
% VOL07-NUMERICAL-CURVATURE-CONFIDENCE-VII42
\begin{remark}[Eigengaps, scale, and confidence of curvature features]
Principal directions become unstable as the shape operator approaches an
umbilic.  The relevant quantity is not only an absolute threshold on
\[
|k_1-k_2|,
\]
but its size relative to perturbations in the estimated shape operator and to
the curvature scale of the neighborhood.  A small eigengap means that a small
matrix perturbation can rotate the principal eigenlines substantially even when
the principal curvature values themselves change only modestly.

Consequently a production ridge/valley detector should keep separate confidence
channels for at least:

\begin{itemize}
\item normal and tangent-frame quality;
\item conditioning of the local surface fit;
\item principal-curvature magnitude and eigengap;
\item stability of the line direction under neighborhood/scale changes;
\item stability of directional-derivative signs and zero crossings;
\item persistence of the final feature under modest mesh or scale perturbation.
\end{itemize}

A ridge detected at one scale is therefore a candidate feature, not an invariant
truth of noisy sampled geometry.  Features that persist across a declared scale
range and remain away from low-confidence or near-umbilic regions have stronger
numerical support.  Direction errors should continue to be measured as line
errors, using the absolute inner product, rather than as oriented-vector errors.
\end{remark}
...
Use the shape operator. Make the controlling geometric criterion explicit before the calculation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Compare \(e\) and \(-e\). Work in a convenient local model first, then return to the invariant statement. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Measure angle from \(e_1\). After the main computation, check the hypotheses and geometric interpretation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Its tangent follows an eigendirection. Make the controlling geometric criterion explicit before the calculation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
The shape operator is self-adjoint. Work in a convenient local model first, then return to the invariant statement. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
The eigenvalues coincide. After the main computation, check the hypotheses and geometric interpretation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Think constant positive curvature. Make the controlling geometric criterion explicit before the calculation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
One bends; one does not. Work in a convenient local model first, then return to the invariant statement. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
It is a directional derivative. After the main computation, check the hypotheses and geometric interpretation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Stationarity along the first principal direction. Make the controlling geometric criterion explicit before the calculation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
A ridge is a local maximum along \(e_1\). Work in a convenient local model first, then return to the invariant statement. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use a local minimum along \(e_2\). After the main computation, check the hypotheses and geometric interpretation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Reverse the normal. Make the controlling geometric criterion explicit before the calculation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Compare an implicit locus with an integral curve. Work in a convenient local model first, then return to the invariant statement. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use a tangent-frame height graph. After the main computation, check the hypotheses and geometric interpretation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Curvature uses second derivatives. Make the controlling geometric criterion explicit before the calculation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Compare the two estimated principal curvatures. Work in a convenient local model first, then return to the invariant statement. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Eigenvalues nearly coincide. After the main computation, check the hypotheses and geometric interpretation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use a dot product. Make the controlling geometric criterion explicit before the calculation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Look along edges. Work in a convenient local model first, then return to the invariant statement. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Noise can create many sign changes. After the main computation, check the hypotheses and geometric interpretation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Remove the sign ambiguity. Make the controlling geometric criterion explicit before the calculation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Mean curvature is only one scalar combination. Work in a convenient local model first, then return to the invariant statement. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
The next volume studies global deformation and invariants. After the main computation, check the hypotheses and geometric interpretation. Compute principal curvature directions and directional derivatives, then apply the ridge or valley sign and extremum conditions along the relevant curvature line.
\end{hint}
