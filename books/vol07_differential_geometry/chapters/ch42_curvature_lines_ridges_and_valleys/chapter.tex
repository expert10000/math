...
Table~\ref{tab:vii42-c16-ridge-robustness} and
Figure~\ref{fig:vii42-c16-scale-stability} report the deterministic resolution,
scale, and noise sweep used by the lightweight feature proxy.  Its reported
lengths are one-dimensional support measures, not claims about surface feature
arc length.
\input{../../code/volume07/results/ridge_valley_robustness.tex}
\input{../../code/volume07/figures/ridge_scale_stability.tex}



% BEGIN C07-CONCEPTUAL-VISUALS
Figure~\ref{fig:vii42-c07-ridge-pipeline} and Table~\ref{tab:vii42-c07-ridge-conventions}
make the directional and stability conventions for ridge and valley extraction explicit.
\input{chapters/ch42_curvature_lines_ridges_and_valleys/c07_visuals}
