...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate and square components.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Differentiate through the inverse $t(s)$.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Normalize the transformed velocity.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Use the chain rule for differentials.
\end{hint}
\begin{solution}
...
\begin{hint}
% PEDAGOGY-ENRICHED-VII
Transform both velocity and $dt$.
\end{hint}
\begin{solution}
...
\begin{problem}[Regular-curve problem]\label{prob:vii12-01}
...
\begin{problem}[Parametrization problem]\label{prob:vii12-02}
...
\begin{problem}[Length problem]\label{prob:vii12-03}
...
\begin{problem}[Arc-length problem]\label{prob:vii12-04}
