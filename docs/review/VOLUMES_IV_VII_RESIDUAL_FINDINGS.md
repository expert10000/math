...
- **R017 / P2 / BUILD_LAYOUT_AUDIT** — status=PASS; overfull=6; underfull=20; undefined=0; reviewed-benign=2026-09-12 → `test(v4-v7): run final cross-volume regression and publication gate` [RESOLVED]
