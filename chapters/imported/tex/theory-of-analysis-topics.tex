...
\begin{figure}[h]
	\centering
	\includegraphics[width=.85\linewidth]{figures/Downloads_hat_fan_n5.png}
	\caption{Hat functions $\Delta_{5,r}(x)$ for $r=-5,\dots,5$ on $[-1,1]$.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=.85\linewidth]{figures/Downloads_hat_fan_n10.png}
	\caption{Denser fan of hats $\Delta_{10,r}(x)$ for $r=-10,\dots,10$.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=.75\linewidth]{figures/Downloads_hat_single_n8_r3.png}
