...
\subsection*{Problem 5 (No compact minimal surfaces in $\mathbb{R}^3$)}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=.48\textwidth]{figures/MATH-ALLS-2_minimal_plane.png}\hfill
		\includegraphics[width=.48\textwidth]{figures/MATH-ALLS-2_minimal_catenoid.png}
		
		\medskip
		\includegraphics[width=.48\textwidth]{figures/MATH-ALLS-2_minimal_helicoid.png}\hfill
		\includegraphics[width=.48\textwidth]{figures/MATH-ALLS-2_minimal_enneper.png}
		\caption{Classic minimal surfaces: plane, catenoid, helicoid, Enneper.}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=.48\textwidth]{figures/MATH-ALLS-2_counter_sphere.png}\hfill
		\includegraphics[width=.48\textwidth]{figures/MATH-ALLS-2_H_paraboloid_counterexample.png}
		
		\medskip
		\includegraphics[width=.60\textwidth]{figures/MATH-ALLS-2_H_scherk_minimal_graph.png}
