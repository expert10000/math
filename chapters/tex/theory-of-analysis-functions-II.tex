...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.55\textwidth]{figures/Downloads_space-diagram.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\textwidth]{figures/Downloads_functions-charts.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.64\textwidth]{figures/Downloads_exampleA_box_function.png}
	
	\smallskip
	
	\includegraphics[width=0.64\textwidth]{figures/Downloads_exampleA_box_fourier.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.64\textwidth]{figures/Downloads_exampleB_bump_function.png}
	
	\smallskip
	
	\includegraphics[width=0.64\textwidth]{figures/Downloads_exampleB_bump_fourier.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.64\textwidth]{figures/Downloads_exampleC_disk_indicator.png}
	
	\smallskip
	
	\includegraphics[width=0.64\textwidth]{figures/Downloads_exampleC_disk_fourier_radial.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.64\textwidth]{figures/Downloads_weak_poisson_f.png}
	
	\smallskip
	
	\includegraphics[width=0.64\textwidth]{figures/Downloads_weak_poisson_u.png}
	
	\smallskip
	
	\includegraphics[width=0.64\textwidth]{figures/Downloads_weak_poisson_uprime.png}
...
\begin{figure}[h!]
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/Downloads_greens_heatmap.png}
		\caption{Dirichlet Green’s function $G(x,y)$ on $(-1,1)$.}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/Downloads_greens_slices.png}
...
\begin{figure}[h!]
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/Downloads_example1_f_block.png}
		\caption{Block forcing $f(x)=\mathbf 1_{[-0.5,\,0.5]}(x)$.}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/Downloads_example1_u_solution.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.68\textwidth]{figures/Downloads_fourier_heaviside_components.png}
...
\begin{figure}[h!]
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/Downloads_periodized_gaussian_compare.png}
		\caption{Direct sum vs. Fourier truncation for $S(x)$.}
	\end{subfigure}\hfill
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/Downloads_periodized_gaussian_errors.png}
...
\begin{center}
	\includegraphics[width=0.7\textwidth]{figures/Downloads_hs_frequency_weights.png}
	
	\smallskip
	
	\includegraphics[width=0.7\textwidth]{figures/Downloads_hs_gagliardo_kernel.png}
	
	\smallskip
	
	\includegraphics[width=0.8\textwidth]{figures/Downloads_hs_bessel_smoothing.png}
\end{center}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.85\textwidth]{figures/Downloads_hs_examples_xspace.png}
	\caption{Three test functions in physical space.}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.85\textwidth]{figures/Downloads_hs_examples_fourier_mag.png}
...
\begin{figure}[h!]
	...
	\begin{minipage}{0.32\textwidth}\centering
		\includegraphics[width=\linewidth]{figures/Downloads_hs_examples_cum_gaussian.png}\\[-2mm]
		{\footnotesize Gaussian}
	\end{minipage}\hfill
	\begin{minipage}{0.32\textwidth}\centering
		\includegraphics[width=\linewidth]{figures/Downloads_hs_examples_cum_indicator.png}\\[-2mm]
		{\footnotesize Indicator}
	\end{minipage}\hfill
	\begin{minipage}{0.32\textwidth}\centering
		\includegraphics[width=\linewidth]{figures/Downloads_hs_examples_cum_bump.png}\\[-2mm]
