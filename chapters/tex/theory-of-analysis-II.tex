...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{figures/Downloads_sinx2_global.png}
	\caption{$f(x)=\sin(x^2)$ on $[-10,10]$.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{figures/Downloads_sinx2_zoom.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{figures/Downloads_dist_n2_global.png}
	\caption{$f(x)=\inf\{|x-n^2|:n\in\mathbb N\}$ on $[0,50]$. Piecewise-linear “sawtooth” with zeros at perfect squares.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{figures/Downloads_dist_n2_zoom.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{figures/Downloads_sinx3_over_xp1_global.png}
	\caption{$f(x)=\sin(x^3)/(x+1)$ on $[-1,20]$ (note the removable pole at $x=-1$).}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{figures/Downloads_sinx3_over_xp1_tail.png}
...
\begin{center}
	\includegraphics[width=0.86\textwidth]{figures/Downloads_clipn_sin2_plot.png}
\end{center}
\noindent
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{figures/Downloads_gprime_semilog.png}
...
\begin{center}
	\includegraphics[width=0.8\textwidth]{figures/Downloads_phi_periodic_plot.png}
\end{center}
\noindent
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{figures/Downloads_weierstrass_partial_sums.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{figures/Downloads_weierstrass_zoom.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=.7\linewidth]{figures/Downloads_curve_C_xy_plane.png}
	\caption{\textbf{Source plane (x,y).} The curve $C:\; x^3+y^3-3xy=0$.}
\end{figure}

\begin{figure}[!ht]
	\centering
	\includegraphics[width=.7\linewidth]{figures/Downloads_image_FC_uv_plane.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\linewidth]{figures/Downloads_F_mapping_xy_to_uv_side_by_side.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=.72\linewidth]{figures/Downloads_problem14_subharmonic_heatmap.png}
